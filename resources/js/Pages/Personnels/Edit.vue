...
// Submit the form
const submit = () => {
    form.put(route('personnels.update', personnel.value.id), {
        onSuccess: () => {
            form.reset();
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Personnel</h2>
        </template>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div class="flex gap-5">
                                <div class="w-1/2">
                                    ...
                                    <select id="sex" name="sex" class="mt-1 block w-full">
                                ...
                                <div class="w-1/2">
                                    ...
                                    <select id="civil_status" name="civil_status" class="mt-1 block w-full">
                                        ...
                                        <option value="SEPERATED">SEPRATED</option>
                                    </select>
                                </div>
                            </div>
                            <div class="flex gap-5">
                                ...
                                <div class="border border-gray-300 rounded-lg p-4">
                                    <div class="grid grid-cols-3 gap-4 mb-4">
                                        <div>
                                            ...
                                            <input v-model="college_education.college_name_school" type="text" :id="'college_name_school' + index" name="college_name_school" class="mt-1 block w-full" />
                                        </div>
                                        <div>
                                            <label for="college_basic_education" class="block text-sm font-medium text-gray-700">Basic Education</label>
                                            <input v-model="college_education.college_basic_education" type="text" :id="'college_basic_education' + index" name="college_basic_education" class="mt-1 block w-full" />
                                        </div>
                                        <div>
                                            <label for="college_from_school" class="block text-sm font-medium text-gray-700">From</label>
                                            <input v-model="college_education.college_from_school" type="text" :id="'college_from_school' + index" name="college_from_school" class="mt-1 block w-full" />
                                        </div>
                                        <div>
                                            <label for="college_to_school" class="block text-sm font-medium text-gray-700">To</label>
                                            <input v-model="college_education.college_to_school" type="text" :id="'college_to_school' + index" name="college_to_school" class="mt-1 block w-full" />
                                        </div>
                                        <div>
                                            <label for="college_highest_level" class="block text-sm font-medium text-gray-700">Highest Level/Year Level</label>
                                            <input v-model="college_education.college_highest_level" type="text" :id="'college_highest_level' + index" name="college_highest_level" class="mt-1 block w-full" />
                                        </div>
                                        <div>
                                            <label for="college_year_graduate" class="block text-sm font-medium text-gray-700">Year Graduated</label>
                                            <input v-model="college_education.college_year_graduate" type="text" :id="'college_year_graduate' + index" name="college_year_graduate" class="mt-1 block w-full" />
                                        </div>
                                        <div>
                                            <label for="college_scholarship" class="block text-sm font-medium text-gray-700">Scholarship/ Honors Received</label>
                                            <input v-model="college_education.college_scholarship" type="text" :id="'college_scholarship' + index" name="college_scholarship" class="mt-1 block w-full" />
                                        </div>
                                    </div>
                                </div>
